# run_kv260_eval.tcl for CNN_V4 VGG16 P256/PV16 wide-word evaluation
# -----------------------------------------------------------------------------
...
proc usage {} {
    ...
    puts "Defaults for VGG16-LIKE-96-P256: -word-bytes 16 -base-addr 0x70000000 -ifm-base-word 0x000000 -wgt-base-word 0x010000 -ofm-base-word 0x020000"
...
set word_bytes [parse_int [arg_value args "-word-bytes" "16"]]
set ifm_base_word [parse_int [arg_value args "-ifm-base-word" "0x000000"]]
set wgt_base_word [parse_int [arg_value args "-wgt-base-word" "0x010000"]]
set ofm_base_word [parse_int [arg_value args "-ofm-base-word" "0x020000"]]
set ifm_size_words [parse_int [arg_value args "-ifm-size-words" "0x010000"]]
set wgt_size_words [parse_int [arg_value args "-wgt-size-words" "0x010000"]]
set ofm_size_words [parse_int [arg_value args "-ofm-size-words" "0x010000"]]
...
log "CNN_V4 KV260 VGG16 P256/PV16 run"
