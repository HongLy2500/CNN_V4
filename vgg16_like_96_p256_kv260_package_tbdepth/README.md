...
This package version sets `HT = 4` for the VGG16-like 96×96 P256 benchmark. The earlier draft used `HT = 3`, but the RTL line/tile lifecycle requires `HT = 4` for the K=3 pipeline to run correctly.
