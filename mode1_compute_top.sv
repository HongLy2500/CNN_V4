module mode1_compute_top #(
  ...
  ce_mode1_top #(
    ...
    .dr_write_bank_sel (dr_write_bank_sel),
    .dr_read_bank_sel  (dr_read_bank_sel),
    .dr_load_start     (dr_load_start),
    .dr_load_done      (dr_load_done),
    .dr_load_c         (dr_load_c),
    .dr_load_out_row   (dr_load_out_row),
